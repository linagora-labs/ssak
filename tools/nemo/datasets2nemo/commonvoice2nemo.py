...
if __name__ == "__main__":
    ...
    if args.input is None:
        args.input = f"/data-server/datasets/audio/transcript/{args.language}/COMMONVOICE/cv-corpus-23.0-2025-09-05/{args.language}"
        print(f"Input path not specified, using default: {args.input}")
    if args.output is None:
        args.output = f"/data-server/datasets/audio/nemo/multi-turn/asr/{args.language}/nocontext/CommonVoice"
